...
| Kerfjs UI standard | [`kerfjs-ui.md`](../kerfjs-ui.md) | **Partial** (VS-115/120/121) — foundation and multi-camera reviewer migration shipped: typed keyed components, one reactive mount, delegated review actions, and preserved media-player DOM. The Tauri webview migration remains VS-119. |
