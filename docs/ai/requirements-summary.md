...
| Kerfjs UI standard | [`kerfjs-ui.md`](../kerfjs-ui.md) | **Required; migration planned** (VS-115) — every shipped interactive UI uses kerfjs TSX, reactive mounts/stores, stable keyed lists, delegated events, and kerf lint rules. Applies to the Tauri webview and multi-camera reviewer; implementation is split into migration follow-ups. |
