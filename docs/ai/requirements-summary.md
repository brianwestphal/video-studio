...
| Desktop app (VS-76 initiative) | [`desktop-app.md`](../desktop-app.md), [`desktop-app-agent-bridge.md`](../desktop-app-agent-bridge.md), [`desktop-app-permissions.md`](../desktop-app-permissions.md) | **Partial** — native Tauri shell, project model/stage rail, sidecar, core screens, and Claude/Codex/Ollama Auto backends are built. The app-owned permission layer is shipped end-to-end (VS-92/97): safe normalized in-project work auto-approves, risky calls open Allow once / Always allow / Deny, remembered rules persist, questions open a native picker, and SDK sandbox auto-approval cannot bypass the app gate. Remaining work is tracked in the screen/polish tickets. |
